...
<nav className="bg-white border-gray-200 dark:bg-gray-900">
  ...
  <a href="https://Easy Rent" className="flex items-center space-x-3 rtl:space-x-reverse">
  <img src='./assests' className="h-8" alt="Easy Rent Logo" />
<span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">EASY RENT</span>
  </a>
