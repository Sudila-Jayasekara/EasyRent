...
const Driverprofile = () => {
  ...
  const handleUpdate = (event) => {
    ...
    axios.patch(`http://localhost:5556/api/driver/${id}`, formData)
      .then(response => {
                ...
                <form className='w-96' onSubmit={handleUpdate}>
                  ...
                  <div className="grid gap-6 mb-6 lg:grid-cols-2">
                    <div>
                      ...
                      <input type="text" id="nic" name="nic" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" value={formData.nic} onChange={handleChange} disabled />
                    </div>
                    <div>
                      <label htmlFor="email" className="block mb-2 text-sm font-medium text-gray-900">Email</label>
                      <input type="email" id="email" name="email" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" value={formData.email} onChange={handleChange} disabled />
                    </div>
                  </div>
                  <div className="mb-6">
