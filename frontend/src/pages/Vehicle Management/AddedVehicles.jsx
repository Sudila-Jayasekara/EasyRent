                            ...
                            <div className="bg-white">
                                ...
                                <div className="p-4">
                                    <div className="flex items-center">
                                        <h2 tabIndex="0" className="focus:outline-none text-lg font-semibold">{detail.name}</h2>
                                        <p tabIndex="0" className="focus:outline-none text-xs text-gray-600 pl-5">Posted on {detail.postedDate}</p>
                                    </div>
                                    <p tabIndex="0" className="focus:outline-double text-wrap text-gray-600 mt-1">{detail.price}</p>
                                    <p tabIndex="0" className="focus:outline-double text-xs text-gray-600 mt-6">{detail.details}</p>
                                    <div className="flex mt-4">
                                        <div>
                                            <p tabIndex="0" className="focus:outline-none text-xs text-gray-600 px-5 bg-gray-200 py-1">{detail.transmission}</p>
                                        </div>
                                        <div className="pl-2">
                                            <p tabIndex="0" className="focus:outline-none text-xs text-gray-600 px-5 bg-gray-200 py-1">{detail.fuel}</p>
                                        </div>
                                    </div>
                                    <div className="flex items-center justify-between py-4">
                                        <h2 tabIndex="0" className="focus:outline-none text-indigo-700 text-xs font-semibold">{detail.location}</h2>
