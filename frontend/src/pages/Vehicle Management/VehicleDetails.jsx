                ...
                <div className="flex flex-col items-center space-y-5">
                  ...
                  <div className="flex flex-col space-y-5 sm:ml-8">
                    <div>
                      ...
                      <input type="text" id="offers" value={vehicle.model} className="bg-gray-50 border border-gray-300 text-red-600 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-10" placeholder="" onChange={handleChange} required />
                      <div>
